  ...
  return (
    ...
    >
      <div className="insert-header">
        <p className="hint">
          Flip "value" off to use the column's database default. A blank value inserts NULL.
        </p>
        <div className="insert-header-actions">
          <button type="button" className="mini ghost" onClick={() => setAll(true)}>
            All
          </button>
          <button type="button" className="mini ghost" onClick={() => setAll(false)}>
            None
          </button>
        </div>
      </div>
